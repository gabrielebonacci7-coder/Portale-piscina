...
# Va impostato PRIMA di importare `app.core.config`, che legge le impostazioni
# a tempo di import. Con 12 round bcrypt la suite impiegherebbe minuti.
...
@pytest.fixture
def piscina(client):
    """Account piscina con profilo. Restituisce (token, ids)."""
